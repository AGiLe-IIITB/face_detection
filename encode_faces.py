...
# grab the paths to the input images in our dataset, then initialize out the data list
...
for (i, imagePath) in enumerate(imagePaths):
    ...
    # detect the (x, y)-coordinates of the bounding boxes correspoding to each face in the input image
